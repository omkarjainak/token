...
import { idlFactory } from './dca_backend.did.js';
export { idlFactory } from './dca_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DCA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dca_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dca_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dca_backend.did.js")._SERVICE>}
 */
export const dca_backend = createActor(canisterId);
