...
import { idlFactory } from './dca_frontend.did.js';
export { idlFactory } from './dca_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DCA_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dca_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dca_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dca_frontend.did.js")._SERVICE>}
 */
export const dca_frontend = createActor(canisterId);
