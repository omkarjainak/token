 ...
 */
export declare class FuncClass<Args extends GenericFuncArgs = GenericFuncArgs, Rets extends GenericFuncRets = GenericFuncRets> extends ConstructType<[PrincipalId, string]> {
    argTypes: Args;
    retTypes: Rets;
    annotations: string[];
    get typeName(): IdlTypeName;
...
export declare class ServiceClass<K extends string = string, Fields extends GenericServiceFields = GenericServiceFields> extends ConstructType<PrincipalId> {
    get typeName(): IdlTypeName;
 ...
 */
export declare function Func<Args extends GenericFuncArgs = GenericFuncArgs, Ret extends GenericFuncRets = GenericFuncRets>(args: Args, ret: Ret, annotations?: string[]): FuncClass<Args, Ret>;
/**
 *
 * @param t Record of string and FuncClass
 * @returns ServiceClass
 */
export declare function Service<K extends string = string, Fields extends GenericServiceFields = GenericServiceFields>(t: Fields): ServiceClass<K, Fields>;
